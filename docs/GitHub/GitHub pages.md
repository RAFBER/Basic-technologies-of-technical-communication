...
In order for a site to be generated by Jekyll using the Just the Docs template, you have to copy the Just the Docs template into your account an the GitHub server.
...
In order for the site to be generated properly, the files structure must look as follows: 
   ...
   *Fig.1-2: Files structure in the repository to publish the web sites using just-the-docs template*
